...
В пакете ACELAN-COMPOS реализован одномерный стержневой конечный элемент (```Bar1Elements```). 
<!-- panels:start -->
...
В пакете ACELAN-COMPOS реализован пространственный стержневой конечный элемент (```BarElements```). 
<!-- panels:start -->
